...
public class SpringLaMiaPizzeriaCrudApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Pizza p1 = new Pizza("Margherite", "Pomodoro e mozzarella", "https://static.cookist.it/wp-content/uploads/sites/21/2018/04/pizza-margherita-fatta-in-casa.jpg", 5.50);
